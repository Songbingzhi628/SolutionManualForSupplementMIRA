...
{\footnotesize 这是我个人挑战自学「 {\tgsc Measure, Integration {\&} Real Analysis, by Sheldon Axler} 」的学习笔记，包括课文补注和部分习题。\par
...
{\scriptsize 我没有任何前置的分析学训练\!\!（就连中学微积分都不会算的那种）\!\!，所以很多题目自然难以给出正确解答；即便我给出解答后自认为没有问题。我想这个情况也是原书作者Axler教授始料未及的。来自网络的习题解答能让苦思冥想而不得的我学到很多。}
}
