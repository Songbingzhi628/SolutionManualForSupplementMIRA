...
\Anchor{0B'1}\ProblemB[]{
	$\tilde{0}=\Bra{a:a<0}=\Qbb\Backslash{\Qbs}\Rightarrow-\tilde{0}=\Bra{a:a<-b\leqslant0}=\tilde{0}.$\TextB{}
	$D=\Bra{a:a<-b,\,b\not\in D}=\Bra{{-a}:-a<-b\Longleftrightarrow a>b,\:b\not\in D}.$\TextB{\vspace{-3pt}}
}\SepLine
...
For any $d\in D,\,\exists\,n\in\Nbp$ suth $b-n\cdot\varepsilon<d\Rightarrow b-n\cdot\varepsilon\in D,$ ctradic.\PfEnd
...
Then $D^-=\emptySet\Longleftrightarrow D\cup\Qbp=\Qbb\Longleftrightarrow\Qbb\Backslash\Qbp\subseteq D\Longleftrightarrow 0\in D\Longleftrightarrow D$ posi. \,And $D$ not posi $\Longleftrightarrow 0\in D^-.$\TextB{}
If $D$ not posi, then $\Par{D^-}{^-}=\Bra{r\in D:r\leqslant0}=D=\Qbb\Backslash D^+.$\vspace{3pt}\par
\BulletPointX $\Par{{-D}}{^+}=\Par{{-D}}\cap\Qbp=\Bra{a:0<a<-b,\:b\not\in D\Longleftrightarrow b\in D^-\nonzero}.$\TextB{}
$\Par{{-D}}{^-}=\Par{\Qbb\Backslash{-D}}\cap\Par{\Qbb\Backslash\Qbp}=\Bra{a:0\geqslant a\geqslant-b,\:\forall b\not\in D}.$\vspace{3pt}\TextB{}
...
\Blind{$CD$}${}=\Bra{{-a}:a\geqslant rt,\:\forall r\in C^-,\,t\in\Par{{-D}}{^-}\Rightarrow 0\geqslant r\notin C,\,0\geqslant t\geqslant -s,\,\forall s\notin D}$\TextB{}
Becs $r\leqslant 0,\,-s\leqslant t\leqslant0\Rightarrow -rs\geqslant rt\geqslant0.$ \,Now $CD=\Bra{{a}:a\leqslant rs\Longleftrightarrow-a\geqslant -rs,\,\forall s\not\in D,\,0\geqslant r\notin C}.$\TextB{}
Thus defining $CD.$ \;Now we show this is equiv to $CD=\Bra{cs:c\in C,\,s\not\in D}.$\TextB{}
\vspace{2pt}\par
\BulletPointX For $C$ posi and $D$ not posi, define $CD=\Bra{rd:r\not\in C,\,d\in D}\Rightarrow CD$ not posi.\TextB{}
\SepLine
