...
\ProblemN{3}{
	\TextA{Supp $F\subseteq\Rbbn$ suth every seq in $F$ has a subseq that convg in $F.$ Prove $F$ is closed bounded.}
...
\ProblemB{
	\TextB{Supp $b\in A\subseteq\RbbP{m},\,f:A\rightarrow\Rbbn.$ Prove}
