...
Then $D^-=\emptySet\Longleftrightarrow D\cup\Qbp=\Qbb\Longleftrightarrow\Qbb\Backslash\Qbp\subseteq D\Longleftrightarrow 0\in D\Longleftrightarrow D$ posi. \;And $\tilde{0}{^-}=\zeroSubs.$\vspace{3pt}\par
...
\BulletPointX For $C$ not posi and $D$ posi, \,define $CD=\Bra{cs:c\in C,\,s\in D^+}.$
\SepLine
