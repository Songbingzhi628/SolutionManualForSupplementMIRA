...
Supp open $G\subseteq\Rbbn$ suth $\Rbbm\Backslash h^{-1}\Par{G}$ not closed. Asum show $h$ continu.\parSol{}
...
\ProblemN{22}{
	\TextA{Supp decre seq $F_{\!1}\supsetneq F_{\!2}\supsetneq\cdots$ non-$\emptySet$ closed bounded subsets of $\;\!\Rbbn.$ Prove $\bigcap_{k=1}^\infty F_{\!k}\neq\emptySet.$}
}Fix one $k.$\;Supp $a_1,a_2,\cdots\in F_{\!1}$ convg to $L\in F_{\!k}\Rightarrow\exists$ subseq $a_{j_1},a_{j_2},\cdots\in F_{\!k}$ convg to $L.$\parSol{}
Asum $\bigcup_{k=1}^\infty\Rbbn\Backslash F_{\!k}=\Rbbn.$ Note that $\Rbbn\Backslash F_{\!1}\subsetneq\Rbbn\Backslash F_{\!2}\subsetneq\cdots$ is an incre seq of non-$\emptySet$ open subsets.\parSol{}
Fix $k>1.$ Then $\forall a\in\BigPar{\Rbbn\Backslash F_{\!k}}\Backslash[\Big]\BigPar{\Rbbn\Backslash F_{\!{k-1}}},\:a\in F_{\!{k-1}}\Backslash F_{\!k},$ and $\exists\,\delta>0,\,B\Par{a,\delta}\subseteq\Rbbn\Backslash F_{\!k}.$
\SepLine
...
}Supp $f\Par{a_1},f\Par{a_2},\cdots$ convg to $\Sup\Bra{\,f\Par{a}:a\in F}.$ Becs $F$ is bounded $\Rightarrow\exists$ subseq $a_{j_1},a_{j_2},\cdots\in F$ convg.
...
}If $f\Par{a}\neq f\Par{b}.$ By Exe\:\!(29), $\forall t\in\Qbb$ suth $t$ between $\,f\Par{a},f\Par{b},$ $\exists\,c\in\Interval{(}{)}{a,b},\;f\Par{c}=t,$ ctradic.\parSol{}
