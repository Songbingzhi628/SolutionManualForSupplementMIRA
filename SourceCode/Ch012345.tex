...
\ChDecl{Ch0B}{0$\cdot$B}{\quad{\ANote $C,D$ are Ddkd cuts.\;\;Numbers used here are always rational.}}
...
\Anchor{0B1}\ProblemN{1}{
	\TextA{Prove {\tgnr\large(a)} $D+\tilde{0}=D,$ \;{\tgnr\large(b)} $-D$ is Ddkd cut, and $D+\Par{{-D}}=\tilde{0}.$}
...
\ProblemN{4}{
	\TextA{Supp $B,C,D$ non0 Ddkd cuts. Show $\Par{BC}D=B\Par{CD},$ $B\Par{C+D}=BC+BD.$}
...
\Anchor{0C2}\ProblemN{2}{
	\TextA{Supp non-$\emptySet$ $U\subseteq V\subseteq\Rbb.$\;Show\;$\supU\leqslant\supV.$
...
\ProblemB[]{
	\TextB{Supp non-$\emptySet$ $A\subseteq\Rbb.$}
}
...
\Anchor{0C6}\ProblemN{6}{
	\TextA{Supp non-$\emptySet$ $A,B\subseteq\Rbb.$ Prove $\Sup\Par{A+B}=\sup A+\sup B,$\FontNorm\;and\;$\Inf\Par{A+B}=\inf A+\inf B.$}
...
\Anchor{0DN065}\ProblemB{
	\TextA{Supp non-$\emptySet$ $A$ is closed and open subsets of $\Rbbn.$ Prove $A=\Rbbn.$}
...
Now $\bigcup_{k=1}^\infty\bigcup_{j=1}^\infty E_{j,k}=\bigcup_{k=1}^\infty I_k=X.$ \,Rearrange the order of the $E$'s.\PfEnd
\SepLine
...
}${^\neg}P\Rightarrow{^\neg}Q:$ \;$\exists\,\varepsilon>0,\forall k\in\Nbp,\exists\,b_k\in A$ suth $\Dvert{b_k-b}{_\infty}<1\big/k$ and $\BigDvert{\,f\Par{b_k}-f\Par{b}}{_\infty}\geqslant\varepsilon.$\parSol{}
\Blind{${^\neg}P\Rightarrow{^\neg}Q:$ \;}Now $\lim_{k\rightarrow\infty}b_k=b$ while $\exists\,\varepsilon>0,\forall m,\exists\,k\geqslant m,\,\BigDvert{\,f\Par{b_k}-f\Par{b}}{_\infty}\geqslant\varepsilon.$\vspace{3pt}\parSol{}
${^\neg}Q\Rightarrow{^\neg}P:$ \;Supp $b_1,b_2,\cdots\in A$ suth $\forall\delta>0,\,\exists\,m,\forall k\geqslant m,\,\Dvert{b_k-b}{_\infty}<\delta.$\parSol{}
\Blind{${^\neg}P\Rightarrow{^\neg}Q:$ \;}Asum $\exists\,\varepsilon>0,\forall m\;\!\Sbra{{\Rightarrow\forall\delta>0}},\exists\,k\geqslant m,\,\BigDvert{\,f\Par{b_k}-f\Par{b}}{_\infty}\geqslant\varepsilon.$ \,Immed.\PfEnd
\SepLine
...
\ProblemN{17}{
	\TextA{Supp uniformly continu $\;\!f\!\!\:,g:\RbbP{\Rbb}.$ Prove $\,f\!\!\:\circ g\in\RbbP{\Rbb}$ is uniformly continu.}
}$\forall\varepsilon>0,\exists\,\delta>0,\,\aXMid{\,f\Par{t_1}-f\Par{t_2}},\,\forall t_1,t_2\in g\Par{\Rbb}$ suth $\aXMid{t_1-t_2}<\delta.$\parSol{}
%suth $t_1=g\Par{a},t_2=g\Par{b},$
Then $\exists\,\rho>0,\forall a,b$ suth $\aMid{a-b}<\rho,$ we have $\aXMid{g\Par{a}-g\Par{b}}<\delta.$\parSol{}
These $g\Par{a},g\Par{b}$ is contained in the set of all pairs of $t_1,t_2.$\PfEnd
\SepLine
...
%\BulletPointX\NoteForSmall{[0.82]}\;\;Supp closed bounded $F\subseteq\Rbbm$ and continu $g:F\rightarrow\Rbbn.$\TextB{}
%Let $g_1,\dots,g_n\in\RbbP{F}$ be suth $\forall a\in F,\,g\Par{a}=\BigPar{g_1\Par{a},\dots,g_n\Par{a}}.$ Then each $g_k$ continu becs $\aXMid{g\Par{a}-g\Par{b}}\leqslant\BigDvert{g\Par{a}-g\Par{b}}{_\infty}.$
%\SepLine
...
Note that by def of sup and inf, \,$\Dvert{F}{_\infty}=-\infty\Longleftrightarrow\Dvert{F}\subZero=\infty\Longleftrightarrow\Dvert{F}{_\infty}\:\!\!<\Dvert{F}\subZero\Longleftrightarrow F=\emptySet.$\parSol{}
...
\又 For a closed bounded $F,$ $\Dvert{F}{_\infty}=\Dvert{a}$ for some $a\in F,$ \:\!simlr for $\Dvert{F}\subZero.$\PfEnd\vspace{3pt}\parSol{}
\Or Pick $a_k\in F_{\!k}$ for each $\Rightarrow\exists$\;\!subseq $a_{j_1},a_{j_2},\cdots$ convg to $a\in\bigcap_{k=1}^\infty F_{\!k}.$
\PfEnd
\SepLine
...
\ProblemN{26}{
	\TextA{Supp $F\subseteq\Rbbn$ suth every continu $\,f\in\RbbP{F}$ attains a max. Prove $F$ is closed bounded.\vspace{-2pt}}
%{\FontSmall Note that $\forall$\:\!continu $-\,f\in\RbbP{F}$ attains a max ${-\,f\Par{a_M}}\Longrightarrow\,f$ attains a min $\,f\Par{a_M}.$}\vspace{-2pt}\parSol{}
%{\FontSmall Thus the asum is equiv to\hspace{1pt}: every continu $\,f:F\rightarrow\Rbbm$ is bounded, where $m$ doesn't matter.}\vspace{-2pt}\parSol{}
%{\FontSmall Asum $\exists$ continu $\,f:F\rightarrow\Rbbm$ suth $\exists\,\,f\Par{a_1},\,f\Par{a_2},\cdots$ convg to $L\notin\,f\Par{F}.$}\vspace{2pt}\parSol{}
%{\FontSmall Let $\,f\Par{a}$}\vspace{-2pt}\parSol{}
%{\FontSmall}\vspace{2pt}\parSol{}
}Asum $F$ not bounded. Define $\,f\Par{a}=\Dvert{a}{_\infty}.$ Ctradic.\parSol{}
Asum $\exists\,a_1,a_2,\cdots\in F$ convg to $L\notin F.$ Define $\,f\Par{a}=1\big/\Dvert{a-L}{_\infty}.$ Ctradic.\PfEnd
\SepLine
...
}Asum $\forall$\:\!countable $A\subseteq\Rbb,$\;$\,f\mmid_{\Rbb\text{\small\backslash}A}$ is not continu at an uncountable set $B$ of elem in $\Rbb\Backslash A.$\parSol{}
$\forall b\in B,\exists\,\varepsilon>0,\forall k\in\Nbp,\exists\,a_k\in\Rbb\Backslash A$\;suth\;$\aMid{a_k-b}<1\big/k,$\;$\aXMid{\,f\Par{a_k}-f\Par{b}}\geqslant\varepsilon.$\parSol{}
Now $a_1,a_2,\cdots$ convg to $b.$
%Let $\varsigma=b\big/\aMid{b}\Rightarrow\varsigma\aMid{a_1},\varsigma\aMid{a_2},\cdots$ is monotone and convg to $b.$
\SepLine
...
While $\aXXMid{${\small$\Frac{a_0}{\:x^m}+\Frac{a_1}{\,\,x^{m-1}}+\dots+\Frac{\,a_{m-1}\,}{x}$}$}\leqslant\delta^m\;\!\aMid{a_0}+\delta^{m-1}\aMid{a_1}+\dots+\delta\;\!\aMid{a_{m-1}}\:\!;$\;let $\delta=1\big/\aMid{x}.$\vspace{5pt}\parSol{}
...
}Supp subseq $a_{j_1},a_{j_2},\cdots$ convg to $L.$ Then $\forall\varepsilon>0,\,$\uline{$\exists\,j_m,$}$\,\forall j_k\in\;\!\!\Bra{\;\!j_m,j_{m+1},\cdots},\:\Dvert{a_{j_k}-L}<\varepsilon,$\vspace{1pt}\parSol{}
and \uuline{$\exists\,n\in\Nbp,$}$\,\forall i\geqslant n,\:\Dvert{a_i-L}=\BigDvert{\Par{a_i-a_{j_k}}+\Par{a_{j_k}-L}}\leqslant\Dvert{a_i-a_{j_k}}+\Dvert{a_{j_k}-L}<2\:\!\varepsilon.$\PfEnd
\SepLine
...
$\Dvert{z_{j_k}-L_y}=\BigDvert{\Par{z_{j_k}-y_{j_k}}+\Par{y_{j_k}-L_y}}<\varepsilon.$ \,Now $x_{j_1},x_{j_2},\cdots\in F_{\!1}$ convg to $L-L_y\notin F_{\!1}.$\PfEnd
\SepLine
\ChEnd

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 累计用时(h)：(思考学习的时长)+(整理代码的时长)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 0.A:  1.25  +    0h
% 0.B:  18.25 + 5.25h
% 0.C:  7     +    2h
...
\ProblemN{A.1}{
	\TextA{Supp bounded $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb$ and $P$ is a parti suth $L\BigPar{\,f,P,\Interval{[}{]}{a,b}}=U\BigPar{\,f,P,\Interval{[}{]}{a,b}}.$}
	\TextA{Show $\,f$ is const.}
}Note that \,$L\BigPar{\,f,\Interval{[}{]}{a,b}}\geqslant L\BigPar{\,f,P,\Interval{[}{]}{a,b}}=U\BigPar{\,f,P,\Interval{[}{]}{a,b}}\geqslant U\BigPar{\,f,\Interval{[}{]}{a,b}}.$\PfEnd\vspace{2pt}\parSol{}
\Or Supp $a<b$ and $P:a=x_0<x_1<\cdots<x_{k+1}=b.$ \,We use induc on $k.$\parSol{}
(i) $k=0\Rightarrow P:a=x_0,x_1=b.$ Becs $L\BigPar{\,f,P,\Interval{[}{]}{a,b}}=\inff\leqslant\,f\Par{x}\leqslant\supf=U\BigPar{\,f,P,\Interval{[}{]}{a,b}}.$\parSol{}
(ii) $k>0.$ Asum if $g:\Interval{[}{]}{c,d}\rightarrow\Rbb$ with $c<d,$ and $Q:c=y_0<y_1<\cdots<y_k=d$\parSol{\Hii}
suth $L\BigPar{g,Q,\Interval{[}{]}{c,d}}=U\BigPar{g,Q,\Interval{[}{]}{c,d}}$, then $g$ is const.\parSol{\Hii}
Back to this $\,f$ and this $P_{\!1}\cup P_{\!2}=P$ with $P_{\!1}:a=x_0<x_1<\cdots<x_k$ and $P_{\!2}:x_k<x_{k+1}=b.$\parSol{\Hii}
Let $A=\Interval{[}{]}{x_0,x_k},\,B=\Interval{[}{]}{x_k,x_{k+1}}.$ \,Then $\,f\mmid_A$ and $\,f\mmid_B$ are const by asum. Consider $\,f\Par{x_k}.$\PfEnd
\SepLine

\ProblemN{A.2}{
	\TextA{Supp $a\leqslant s<t\leqslant b.$ Define $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb$ by $\,f\Par{x}=\FontNorm\MathLeftBrace{l}{\!\!1,\;\;s<x<t,\\[-2pt]\!\!0,\hfill\text{othws.}}$\vspace{-8pt}}
	\TextA{Prove $\,f$ is Rieman integ on $\Interval{[}{]}{a,b}$ and $\int_a^b\:\!f=t-s.$\vspace{4pt}}
}Consider $P_{\:\!\!\!\varepsilon}:a,\;\!s-\varepsilon,\;\!s+\varepsilon,\;\!t-\varepsilon,\;\!t+\varepsilon,\;\!b$ with $0<\varepsilon<\min\!\Bra{s-a,\;\!2\Par{t-s},\;\!b-t}.$\parSol{}
Now $ t-s-2\:\!\varepsilon=L\Par{\,f,P_{\:\!\!\!\varepsilon},\Interval{[}{]}{a,b}},$ and $U\Par{\,f,P_{\:\!\!\!\varepsilon},\Interval{[}{]}{a,b}}=
%\BigPar{\Par{s+\varepsilon}-\Par{s-\varepsilon}}\cdot 1+\BigPar{\Par{t-\varepsilon}-\Par{s+\varepsilon}}\cdot 1+\BigPar{\Par{t+\varepsilon}-\Par{t-\varepsilon}}\cdot 1=
t-s+2\:\!\varepsilon.$\parSol{}
Thus $t-s\leqslant L\Par{\,f,\Interval{[}{]}{a,b}}\leqslant U\Par{\,f,\Interval{[}{]}{a,b}}\leqslant t-s.$\PfEnd
\SepLine\pagebreak

\Anchor{1Tips}\BulletPointX\Tips\,\,\,Supp $I=\Interval{[}{]}{a,b}$ and $\,f:I\rightarrow\Rbb$ is bounded and $P,P'$ are parti. Let $P''=P\cup P'.$ Then\vspace{1pt}\TextB{}
(a) Supp $g:I\rightarrow\Rbb$ is bounded. Now $\Inf_{I}\;f+\Inf_{I}\,g\leqslant\Inf_{I}\Par{\,f+g}\leqslant\Sup_{I}\Par{\,f+g}\leqslant\Sup_{I}\;f+\Sup_{I}\,g.$\TextB{}
\Ha(1) $L\Par{\,f,P}+L\Par{g,P}\leqslant L\Par{\,f+g,P}\leqslant L\Par{\,f+g},$ 又 $L\Par{\,f,P}+L\Par{g,P'}\leqslant L\Par{\,f,P''}+L\Par{g,P''}.$\TextB{}
\Ha(2) $U\Par{\,f+g}\leqslant U\Par{\,f+g,P}\leqslant U\Par{\,f,P}+U\Par{g,P},$ 又 $U\Par{\,f,P''}+U\Par{g,P''}\leqslant U\Par{\,f,P}+U\Par{g,P'}.$\TextB{}
\Ha Hence \,$L\Par{\,f}+L\Par{g}\leqslant L\Par{\,f+g}\leqslant U\Par{\,f+g}\leqslant U\Par{\,f}+U\Par{g}.$
%\TextB{}
%\Ha\ACoro\Onumber{4}\quad$f,g$ Rieman integ $\Rightarrow\:\!f+g$ Rieman integ and $\int_a^b\!\BigPar{\,f+g}=\int_a^b\:\!f+\int_a^bg.$
\vspace{-3pt}\SepLine[-3pt][\Blind{\BulletPointX} ]\TextB{}
(b) $-L\Par{\,f,P}=U\Par{{-}\,f,P},\,\Inf\Par{{-A}}=-\sup A,$ 又 $-\Par{{-f}}=\;\!f$ and $-\Par{{-A}}=A.$\TextB{}
\Hb Let $U_{f}=\Bra{U\Par{\,f,P}=-L\Par{{-}\,f,P}:P\text{ is a parti}}=-L_{-f}$\TextB{}
\Hb$\Longrightarrow U\Par{\,f}=\inf U_f=-\sup L_{-f}=-L\Par{{-\,f}}.$
\vspace{-3pt}\SepLine[-3pt][\Blind{\BulletPointX} ]\TextB{}
%\Hb\ACoro\Onumber{A.5}\quad$f$ Rieman integ $\Rightarrow -L\Par{{-\,f}}=U\Par{\,f}=L\Par{\,f}=-U\Par{{-\,f}}\Rightarrow{-\,f}$ Rieman integ.
(c) $U\Par{P}-L\Par{P'}\geqslant U\Par{P''}-L\Par{P''}\Longrightarrow U-L=\Inf\Bra{U\Par{P}-L\Par{P'}:P,P'}=\Inf\Bra{U\Par{P}-L\Par{P}:P}.$
\vspace{-3pt}\SepLine[0pt][\Blind{\BulletPointX} ]\TextB{}
%Becs $\forall\varepsilon>0,\exists\,P''$ suth $U\Par{\Interval{[}{]}{a,b}}+\varepsilon>U\Par{P'',\Interval{[}{]}{a,b}}.$\TextB{}
%\Hd\又 $U\BigPar{P''\cup\Bra{c},\Interval{[}{]}{a,b}}=U\Par{P,\Interval{[}{]}{a,c}}+U\Par{P',\Interval{[}{]}{c,b}}.$ Thus $U\Par{\Interval{[}{]}{a,b}}+\varepsilon\geqslant U\Par{\Interval{[}{]}{a,c}}+U\Par{\Interval{[}{]}{c,b}}.$\TextB{}
%\Hd And $\forall\varepsilon>0,\exists\,P,P'$ suth $U\Par{\Interval{[}{]}{a,c}}+U\Par{\Interval{[}{]}{c,b}}+\varepsilon>U\Par{P,\Interval{[}{]}{a,c}}+U\Par{P',\Interval{[}{]}{c,b}}=U\Par{P'',\Interval{[}{]}{a,b}}.$\TextB{}
%\Hd Hence $U\Par{\Interval{[}{]}{a,b}}=U\Par{\Interval{[}{]}{a,c}}+U\Par{\Interval{[}{]}{c,b}}.$ Simlr for $L\Par{\Interval{[}{]}{a,b}}.$\TextB{}
(d) $U\Par{\Interval{[}{]}{a,b}}\leqslant U\Par{P\cup P',\Interval{[}{]}{a,b}}=U\Par{P,\Interval{[}{]}{a,c}}+U\Par{P',\Interval{[}{]}{c,b}}\geqslant U\Par{\Interval{[}{]}{a,c}}+U\Par{\Interval{[}{]}{c,b}}$\TextB{}
\Hd$\Longrightarrow U\Par{\Interval{[}{]}{a,b}}=U\Par{\Interval{[}{]}{a,c}}+U\Par{\Interval{[}{]}{c,b}}.$ Simlr for $L\Par{\Interval{[}{]}{a,b}}.$
\SepLine

\BulletPointX\NewNotation\;\;$\Delta_{\,f}\BigPar{\Interval{[}{]}{a,b}}=U\Par{\,f,\Interval{[}{]}{a,b}}-L\Par{\,f,\Interval{[}{]}{a,b}},$\,\,$\Delta_{\,f}\BigPar{P,\Interval{[}{]}{a,b}}=U\Par{\,f,P,\Interval{[}{]}{a,b}}-L\Par{\,f,P,\Interval{[}{]}{a,b}}.$
\SepLine

\ProblemN{A.3}{
	\TextA{Supp bounded $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$}
	\TextA{Prove $\,f$ Rieman integ $\Longleftrightarrow\forall\varepsilon>0,\exists$ parti $P$ suth $U\Par{\,f,P}-L\Par{\,f,P}<\varepsilon.$}
}\Lpf $0\leqslant U-L\leqslant\Inf\Bra{U\Par{P}-L\Par{P'}:P,P'}\leqslant\Inf\Bra{U\Par{P}-L\Par{P}:P}=0.$\parSol{}
\Rpf Immed by \TIPSN{c}. \,\Or $\forall\varepsilon>0,\exists\,P_{\:\!\!\!1},P_{\:\!\!\!2}$ suth $U\Par{P_{\:\!\!\!1}}<U+\varepsilon,\;L-\varepsilon<L\Par{P_{\:\!\!\!2}}$\parSol{\HRpf}
$\Longrightarrow\forall\varepsilon>0,\exists\,P=P_{\:\!\!\!1}\cup P_{\:\!\!\!2}$ suth $U\Par{P}-L\Par{P}\leqslant U\Par{P_{\:\!\!\!1}}-L\Par{P_{\:\!\!\!2}}<2\:\!\varepsilon.$\PfEnd
\SepLine

%\ProblemN{A.6}{
%	\TextA{Supp Rieman integ $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb,$ \,and $a<b.$ \,Supp $T\subseteq\Interval{[}{]}{a,b}$ is non-$\emptySet$ countable.\vspace{3pt}}
%	\TextA{Supp $g:\Interval{[}{]}{a,b}\rightarrow\Rbb$ suth $g\Par{x}=\;\!f\Par{x}$\;for all $x\in\Interval{[}{]}{a,b}\Backslash T.$\vspace{1.5pt}}
%	\TextA{Prove $g$ Rieman integ and $\int_a^bg=\int_a^b\:\!f.$\vspace{4pt}}
%}Becs $T$ countable. Let $\aMid{T}=n.$ Asum true for (i) $n=1.$\parSol{}
%(ii) $n>1.$ Asum true for $\Par{n-1}.$ Define $h\Par{x}=\;\!f\Par{x}$ for all $x\in\Interval{[}{]}{a,b}\Backslash\Bra{t_2,t_3,\dots}.$
%\SepLine

%\ProblemN{A.7}{
%	\TextA{Supp bounded $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$ {\FontNorm Let $P_{\!n}$ be the parti that divides $\Interval{[}{]}{a,b}$ into $2^n$ intervals of equal size.}\vspace{2pt}}
%	\TextA{Prove $L\Par{\,f}=\lim_{n\rightarrow\infty}\;\!\!L\Par{\,f,P_{\!n}}$ and $U\Par{\,f}=\lim_{n\rightarrow\infty}\:\!\!U\Par{\,f,P_{\!n}}.$}
%}
%\SepLine

%\ProblemN{A.8}{
%	\TextA{Supp Rieman integ $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$ Prove $\int_a^b f=\lim\limits_{k\rightarrow\infty}{}${\LARGE$\frac{\:b\,-\,a\:}{n}$}${}\sum\limits_{j=1}^n\,f\BigPar{a+{}${\FontSmall\LARGE$\frac{\;j\Par{b\,-\,a}\:}{n}$}$}.$}
%}
%\SepLine

%\ProblemN{A.9}{
%	\TextA{Supp Rieman integ $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb,$ and $a\leqslant c<d\leqslant b.$ Prove $\,f$ Rieman integ on $\Interval{[}{]}{c,d}.$}
%}$U\Par{\,f,\Interval{[}{]}{c,d}}-L\Par{\,g,\Interval{[}{]}{c,d}}\leqslant U\Par{\,f,P,\Interval{[}{]}{c,d}}-L\Par{\,g,P,\Interval{[}{]}{c,d}}\leqslant U\Par{\,f,P,\Interval{[}{]}{a,b}}-L\Par{\,g,P,\Interval{[}{]}{a,b}}.$\PfEnd
%\SepLine

%\ProblemN{A.10}{
%	\TextA{Supp bounded $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb$ and $c\in\Interval{(}{)}{a,b}.$ Supp $\,f$ Rieman integ on $\Interval{[}{]}{a,c}$ and $\Interval{[}{]}{c,b}.$}
%	\TextA{Prove $\,f$ Rieman integ on $\Interval{[}{]}{a,b},$ and $\int_a^b\:\!f=\int_a^c\:\!f+\int_c^b\:\!f.$}
%}Denote $P_{\!\!\!\:1}$ as any parti of $\Interval{[}{]}{a,c},$ and $P_{\!\!\!\:2}$ as any parti of $\Interval{[}{]}{c,b}.$ Let $P=P_{\!\!\!\:1}\cup P_{\!\!\!\:2}.$\parSol{}
%Then $\forall\varepsilon>0,\exists\;\!$corres parti,\;$\Delta\BigPar{P,\Interval{[}{]}{a,b}}\leqslant\Delta\BigPar{P_{\!\!\!\:1},\Interval{[}{]}{a,c}}+\Delta\BigPar{P_{\!\!\!\:2},\Interval{[}{]}{c,b}}<\varepsilon.$\parSol{}
%\PfEnd
%\SepLine

\ProblemN{A.12}{
	\TextA{Supp Rieman integ $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$ Prove $\aMid{\,f}$ Rieman integ and $\aXMid{\!\int_a^b\:\!f}\leqslant\int_a^b\aMid{\,f}$}
}
\SepLine

\ProblemN{A.14}{
	\TextA{Supp $\,f_1,\,f_2,\cdots$ Rieman integ seq and convg uniformly on $\Interval{[}{]}{a,b}$ to $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$}
	\TextA{Prove $\,f$ Rieman integ and $\int_a^b\:\!f=\lim_{n\rightarrow\infty}\!\int_a^b\:\!f_n.$}
}
\SepLine
