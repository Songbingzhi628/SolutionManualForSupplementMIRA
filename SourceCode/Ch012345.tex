...
\ACoro $\Bra{a_1+a_2:a_1,a_2\in D}=D+D=\tilde{0}=\Bra{a:a<0}\Longrightarrow\forall a\in D,\,a+a<0\Longleftrightarrow a<0.$
\SepLine
...
\Anchor{0B5}\ProblemN{5}{
	\TextA{Prove $D$ is posi $\Longleftrightarrow -D$ is not posi $\Longleftrightarrow 0\in D.$}
}$0\not\in-D=\Bra{a:a<-b,\,b\not\in D}\Longleftrightarrow\nexists\,b\not\in D,\,b<0\Longleftrightarrow\Qbb\Backslash\Qbp\subsetneq D\Longleftrightarrow 0\in D.$\PfEnd
\SepLine

\BulletPointX Define $D^+=\Bra{d\in D:d>0}=D\cap\Qbp.$ \,Then $D^+=\emptySet\Longleftrightarrow D\subsetneq\Qbb\Backslash\Qbp\Longleftrightarrow 0\not\in D\Longleftrightarrow D$ not posi.\vspace{2pt}\TextB{}
Define $D^-=\Bra{r\not\in D:r\leqslant 0}=\Par{\Qbb\Backslash D}\cap\Par{\Qbb\Backslash\Qbp}=\Qbb\Backslash\Par{D\cup\Qbp}.$\TextB{}
(a) $D^-=\emptySet\Longleftrightarrow D\cup\Qbp=\Qbb\Longleftrightarrow\Qbb\Backslash\Qbp\subseteq D\Longleftrightarrow 0\in D\Longleftrightarrow D$ posi. \hfill\ACoro $D$ not posi $\Longleftrightarrow 0\in D^-.$\TextB{}
(b) $\Par{D^-}{^-}=\Bra{r\in D:r\leqslant0}=\Qbb\Backslash D^+.$ \hfill\ACoro $D$ not posi $\Longleftrightarrow\Par{{-D}}{^-}=D.$
\SepLine
...
Note that $\Bra{cd:c\in C^+,d\in D^+}=CD\cap\Qbp=\Par{CD}{^+}.$\vspace{4pt}\par
\BulletPointX For $C,D$ not posi, \,define $CD=\Par{{-C}}\Par{{-D}}=\Bra{cd:c\in\Par{{-C}}{^+},d\in\Par{{-D}}{^+}}\cup\Par{\Qbb\Backslash\Qbp}.$\TextB{}
$CD=\Bra{0<cd<\Par{{-r}}\Par{{-s}}:r\in C^-\nonzero,\,s\in D^-\nonzero}\cup\Par{\Qbb\Backslash\Qbp}=\Bra{a:a<rs,\,r\in C^-,\,s\in D^-}.$\vspace{2pt}\par
\BulletPointX {\normalsize The intuitive key point is that the prod of cuts is the cut with the endpoint being the prod of endpoints of cuts.}\vspace{2pt}\par
\BulletPointX For $C$ not posi and $D$ posi, we expect that $CD$ not posi.\TextB{}
$CD=-C\Par{{-D}}=-\Bra{a:a<rt,\:r\in C^-,\,t\in\Par{{-D}}{^-}}$\TextB{}
\Blind{$CD$}${}=\Bra{{-a}:a>rt,\:\forall r\in C^-,\,0\geqslant t\geqslant -s,\,\forall s\notin D}$\hfill{\FontSmall \BigPar{$r\leqslant 0,\,-s\leqslant t\leqslant0\Rightarrow -rs\geqslant rt\geqslant0$}}\TextB{}
\Blind{$CD$}${}=\Bra{{-a}:a>-rs,\,\forall s\not\in D,\,r\in C^-}=\Bra{{a}:a<rs,\,\forall s\not\in D,\,r\in C^-}.$\hfill Note the `$\forall$' here.
\SepLine\pagebreak

\BulletPointX \Or $CD=-\Sbra{\Par{{-C}}D}=-\Bra{a:a\leqslant cd,\,c\in\Par{{-C}}{^+},\,d\in D^+}$\TextB{}
\Blind{\Or $CD$}${}=\Bra{{a}:a$\uline{${}<-b<{}$}$-cd,\,\forall d\in D^+,\,\forall c\text{\;suth\;}$\uline{$0<c<-c',\,\exists\,c'$}${}\not\in C}$\hfill{\FontSmall\BigPar{$0<{}$\uline{$cd<-c'd$}}}\vspace{3pt}\TextB{}
...
\Ha \!又 $\forall b<M,\,\exists\,\epsilon>0,\:b+\epsilon<M\Rightarrow b\in B.$\vspace{2pt}\TextB{}
%(b) $\Bra{r:a<r,\,\forall a\in A}\supseteq\Bra{r:M\leqslant r}.$\TextB{}
%\Hb \!又 Supp $r$ suth $\forall a\in A,\,r>a.$ If $r<M,$ then $r\in A\Rightarrow\exists\,r'\in A,\,r'>r.$\vspace{2pt}\TextB{}
(b) $A=\Bra{a:M<a},\,B=\Bra{b:b<a,\,\forall a\in A}\supseteq\Bra{b:b\leqslant M}$\TextB{}
\Hb \!又 Supp $b$ suth $\forall a\in A,\,b<a.$ If $b>M,$ then $b\in A\Rightarrow\exists\,b'\in A,\,b'<b.$\vspace{3pt}\TextB{}
$CD=\Bra{a:a<-cd,\:\forall d\in D^+,\,$\uline{$\forall c\text{\;suth\;}0<c<-c',\,\exists\,c'\notin C$}$}$\hfill{\FontSmall\BigPar{$c'd<-cd<0$}}\TextB{}
$\Blind{CD}=\Bra{a:a\leqslant c'd,\;$\uline{$\forall c'\in C^-,$}$\,\forall d\in D^+}$\TextB{\vspace{-20pt}}
\hspace{310pt}\begin{tikzpicture}[>=stealth, every node/.style={font=\scriptsize},scale=1.4]
	\draw[->, thick] (-2,0) -- (1.8,0);
	\draw[-, thick] (-1.5,0) -- (-1.5,0.16);
	\draw[-, thick] (0,0) -- (0,0.3);
	\draw[-, thick] (1.2,0) -- (1.2,0.3);
	\draw[-, thick] (-1.5,0.16) -- (0,0.16);
	\draw[-, thick] (0,0.3) -- (1.2,0.3);
	\draw (0,0) circle [radius=2pt]
	node [below=2pt] {0};

	\fill[black] (-1.5,0) circle [radius=2pt]
	node [below=2pt] {$\sup C$};

	\draw (1.2,0) circle [radius=2pt]
	node [below=2pt] {$\sup D$};
\end{tikzpicture}\vspace{-10pt}
\SepLine

\BulletPointX For $C$ not posi and $D$ posi, to make $CD=DC,$ we define\TextB{} $CD=\Bra{a:a<rs,\,\forall s\not\in C,\,s\in D^-}=\Bra{a:a\leqslant cd,\;\forall c\in C^+,\,d\in D^-}.$
\SepLine
...
\BulletPointX
%For $C$ posi, $D$ not posi: $-\Sbra{C\Par{{-D}}}=\Bra{cd':cd'\leqslant-xy',\,xy'\not\in C\Par{{-D}}}.$\TextB{}
%$C\Par{{-D}}=\Bra{a:a\leqslant cd,\,c\in C^+,d\in\Par{{-D}}{^+}}=\Bra{a:a<-cd,\,c\in C^+,d\in D^-}.$\TextB{}
\TextB{}
\TextB{}
\TextB{}
%\Bra{cs:c\in C,s\in\Qbb\Backslash D}\parNot{\IndentB}
%For $C$ not posi, $D$ posi $\Longleftrightarrow -C$ posi, $-D$ not posi: $\Par{{-C}}\Par{{-D}}=\Bra{c's':c'\in-C,\,s'\not\in{-D}}.$\TextB{}
%Note that $\Qbb\Backslash{-D}=\Bra{a\in\Qbb:a\geqslant -b,}$
%$\Bra{rd:r\in\Qbb\Backslash C,d\in D}.$\parNot{\IndentB}
\SepLine
...
}(a) Supp $C\subsetneq D.$ \,Let \:\!$d\in D\Backslash C\subseteq\Qbb\Backslash C.$ For any $a\in\tilde{0},$ \:let $\,y=d-a>d\Rightarrow a=d-y\in D-C.$\vspace{2pt}\parSol{}
(b) Supp $D-C$ posi. Becs $d=y$ for some $d\in D,\,y>x\not\in C.$\parSol{\Hb}
Note that $x\not\in C\Rightarrow\forall c\in C,\,c<x<y=d\Rightarrow C\subseteq D.$\PfEnd
\SepLine
