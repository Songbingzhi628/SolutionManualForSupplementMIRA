...
Then $D^-=\emptySet\Longleftrightarrow D\cup\Qbp=\Qbb\Longleftrightarrow\Qbb\Backslash\Qbp\subseteq D\Longleftrightarrow 0\in D\Longleftrightarrow D$ posi. \;And $\tilde{0}{^-}=\zeroSubs.$\vspace{3pt}\TextB{}
$\Par{{-D}}{^+}=\Par{{-D}}\cap\Qbp=\Bra{a:0<a<-b,\:b\in\Par{\Qbb\Backslash D}\cap\Par{\Qbb\Backslash\Qbs}\subseteq D^-}.$\TextB{}
...
Note that $\Bra{cd:c\in C^+,d\in D^+}=CD\cap\Qbp=\Par{CD}{^+}.$%\vspace{2pt}\TextB{}
\SepLine

\BulletPointX For $C,D$ posi, \,define $\Par{{-C}}\Par{{-D}}=CD.$
\SepLine
...
\BulletPointX We want to define $CD$ for posi $C$ and non-posi $D.$\TextB{}
For non-posi $D,$ \;define $-\tilde{1}D=\tilde{1}\Par{{-D}}=-D.$ \quad For posi $C,$ \;define $-\tilde{1}C=-C.$\TextB{}
$CD=C\Par{{-\tilde{1}{-D}}}$
\SepLine

\BulletPointX
%For $C,D$ not posi $\Longleftrightarrow -C,-D$ posi:\TextB{}
%$CD=\Par{{-C}}\Par{{-D}}=\Bra{a:a\leqslant cd,\,c\in\Par{{-C}}{^+},\,d\in\Par{{-D}}{^+}}=\Bra{a:a<cd,\:c\in C^-,\,d\in D^-}.$\vspace{2pt}\TextB{}
