...
\Anchor{0D13}\ProblemN{13}{
	\TextA{Supp $0\notin A\subseteq\Rbb.$ \,Let $A^{-1}=\Bra{a^{-1}:a\in A}.$}
	\PrePa\TextA{Prove $A$ is open $\Rightarrow A^{-1}$ is open. \;{\tgnr\large(b)} Give a closed $A$ suth $A^{-1}$ is not closed.}
}
\SepLine
