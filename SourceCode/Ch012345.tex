...
%(I) $RHS=\Sup\Bra{\varphi_2\Par{pq}:p,q\in\Qbb,\,\varphi_1\Par{p}\leqslant a,\;\varphi_1\Par{q}\leqslant b}.$\parSol{\Hd}
%(II) $RHS=\Sup\Bra{\gamma\:\!\varphi_2\Par{q}:q\in\Qbb,\,\varphi_1\Par{q}\leqslant b,\text{and\;}\gamma\geqslant\varphi_2\Par{p},\forall p\text{\;suth\;}\varphi_1\Par{p}\leqslant a}.$\parSol{\Hd\HII}
%$\Blind{RHS}=\Sup\Bra{\varphi_2\Par{pq}:p,q\in\Qbb,\,\varphi_1\Par{p}\leqslant a,\;\varphi_1\Par{q}\leqslant b}.$\vspace{2pt}\parSol{\Hd}
%Thus $LHS\geqslant RHS.$ \,Asum it is `$>$'. Now $\exists\,t\in\Qbb$ suth\;$LHS\geqslant\varphi_2\Par{t}>RHS.$\parSol{\Hd}
%Which means\;$\varphi_2\Par{t}>\varphi_2\Par{pq},\,\forall p,q\in\Qbb$ suth\;$\varphi_1\Par{p}\leqslant a,\,\varphi_1\Par{q}\leqslant b.$\parSol{\Hd}
%Now $ab\geqslant\varphi_1\Par{t}>\varphi_1\BigPar{p\Par{q+\delta}}>\varphi_1\Par{pq},\forall p,q.$ \,Ctradic.\PfEnd
Asum $LHS>RHS\Rightarrow\exists\,t\in\Qbb$ suth\;$LHS\geqslant\varphi_2\Par{t}>RHS.$\parSol{\Hd}
Which means\;$\varphi_2\Par{t}>\psi\Par{a}\:\!\varphi_2\Par{q},\,\forall q\in\Qbb$ suth\;$\varphi_1\Par{q}\leqslant b$\parSol{\Hd}
(I) $\Longrightarrow\varphi_2\Par{t}>\varphi_2\Par{s}\:\!\varphi_2\Par{q},\,\forall q$ and $\forall s\in\Qbb$ suth $\varphi_2\Par{s}\geqslant\varphi_2\Par{p},\forall p$ suth\;$\varphi_1\Par{p}\leqslant a$\parSol{\Hd}
(II) $\Longrightarrow\varphi_2\Par{t}>\varphi_2\Par{s}\:\!\varphi_2\Par{q},\,\forall q$ and $\forall s\in\Qbb$ suth\;$0<\varphi_1\Par{s}\leqslant a.$\parSol{\Hd}
$\Longleftrightarrow ab\geqslant\varphi_1\Par{t}>\varphi_1\Sbra{\Par{t+sq}\big/2}>\varphi_1\Par{sq},\forall s,q.$ \,Ctradic.\PfEnd\SepLine
\ChEnd
\pagebreak
