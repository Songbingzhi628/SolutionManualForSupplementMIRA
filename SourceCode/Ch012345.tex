...
\BulletPointX Note that \,$\Bra{u:0<u\leqslant s,\,\forall s\notin D}=\MathLeftBrace{l}{\!D^+\cup\Bra{{\min\Qbb\Backslash D}},\,\,\text{if it exis,}\\\!D^+,\hfill\text{othws.}}$\vspace{8pt}
\SepLine
...
But $CD=-\Par{{-C}}D=-\Bra{a:a\leqslant cd,\,\,c\in\Par{{-C}}{^+},\,d\in D^+}\neq\Bra{a:a<-cd,\;\forall c\in\Par{{-C}}{^+},\,d\in D^+}.$
%$\Blind{CD}=\Bra{a:a<-cd,\;\forall d\in D^+,\,\forall c\text{\;suth\;}$\uline{$0<c<-r,\,\exists\,r$}${}\in C^-\nonzero}$\hfill{\FontSmall\BigPar{$rd<-cd<0$}}\TextB{}
%$\Blind{CD}=\Bra{a:a<td,\;\forall d\in D^+,\,\forall t\text{\;suth\;}r<t<0,\,\exists\,r\in C^-\nonzero}.$\vspace{4pt}\par
%\BulletPointX Note that \,$\Bra{t:r<t<0,\,r\in C^-\nonzero}=\MathLeftBrace{l}{\!C^-\Backslash\Bra{0,\min\Qbb\Backslash C},\,\,\text{if it exis,}\\\!C^-\nonzero,\hfill\text{othws.}}$\vspace{8pt}
\SepLine
...
%$CD=-\Sbra{C\Par{{-D}}}=-\Bra{a:a\leqslant cd,\,c\in C^+,\,d\in\Par{{-D}}{^+}}=\Bra{{-a}:a>b,\,b>cd,\,\forall c\in C^+,\,d\in\Par{{-D}}{^+}}$\TextB{}
...
\BulletPointX $LHS=\Bra{a:a<ru,\;\forall r\in C^-\!,\;\forall u\text{\;suth\;}0<u\leqslant s,\,\forall s\notin D},\;\Bra{cs:c\in C,\,s\notin D}=RHS.$\TextB{}
...
$CD=\Par{{-C}}\Par{{-D}}=\Bra{a:a<ru,\;\forall r\in\Par{{-C}}{^-},\;\forall u\text{\;suth\;}0<u\leqslant s,\:\forall s\notin -D}$\TextB{}
...
\BulletPointX For $D$ posi, \;$\tilde{1}\:\!D=\Bra{a:a\leqslant ij<j,\;0<i<1,\;j\in D^+}\subseteq D.$\TextB{}
Now $\BigPar{\tilde{1}\:\!D}{^+}\subseteq D^+.$ \;又 $\forall d\in D^+,\,\exists\,\varepsilon>0,\:d+\varepsilon\in D^+\Rightarrow d=\Par{d+\varepsilon}\:\!${\Large$\frac{d}{\:d\,+\,\varepsilon\:}$}${}\in\tilde{1}\:\!D.$\vspace{4pt}\TextB{}
For $D$ not posi, \;$\tilde{1}\:\!D=\Bra{rd:r\geqslant 1,\,d\in D}=D.$
\SepLine
\pagebreak
...
(4) $\Par{BC}{^-}=\Bra{r:0\geqslant r\geqslant bc,\,\exists\,c\in C^-,\,\exists\,b\text{\;suth\;}\forall x\notin B,\,0<b\leqslant x}.$\par\quad
\Blind{(4)} $\Par{BC}D=\Bra{a:a<rs,\:r\in\Par{BC}{^-},\,s\in D^-}$\par\quad
\Blind{(4)} $\Blind{\Par{BC}D}=\Bra{a:a<bcs,\,\exists\,s\in D^-,\,c\in C^-,\,\exists\,b\text{\;suth\;}\forall x\notin B,\,0<b\leqslant x}.$\par\quad
...
\Blind{(4)} Note that \,$\Bra{q:q<b,\,b\in B^+}=\Bra{q:q<b,\,\exists\,b\text{\;suth\;}\forall x\notin B,\,0<b\leqslant x}.$ \;Done.\vspace{6pt}\par\quad
...
\Blind{(4)} $\Blind{B\Par{C+D}}=\Bra{a:a<ru,\,\forall r\text{\;suth\;}\forall x\notin B,\,0<r\leqslant x,\;\forall u\text{\;suth\;}0\geqslant u\geqslant c+d,\,\exists\,c\in C^-,\,d\in D^-}$\par\quad
\Blind{(4)} $\Blind{B\Par{C+D}}=\Bra{a:a<r\Par{c+d},\,\forall r\text{\;suth\;}\forall x\notin B,\,0<r\leqslant x,\;\forall c\in C^-,\,d\in D^-}.$\par\quad
\Blind{(4)} $BC+BD=\Bra{x:x<pc,\,\forall p\text{\;suth\;}\forall b\notin B,\,0<p\leqslant b,\;\forall c\in C^-}$\vspace{3pt}\par\quad
\Blind{(4)} $\Blind{BC+BD={}}+\Bra{y:y<qd,\,\forall q\text{\;suth\;}\forall b\notin B,\,0<q\leqslant b,\;\forall d\in D^-}$\par\quad
\Blind{(4)} $=\Bra{a:a<pc+qd,\,\forall p\text{\;suth\;}\forall b\notin B,\,0<p\leqslant b,\,\,\forall q\text{\;suth\;}\forall b\notin B,\,0<q\leqslant b,\;\forall c\in C^-,\,d\in D^-}.$\vspace{1pt}\par\quad
\Blind{(4)} Think intuitively. Easy to prove.\vspace{6pt}\par\quad
(6) $\Par{BC}{^-}=\Bra{r:0\geqslant r\geqslant bc,\,\exists\,b\in B^-,\,\exists\,c\text{\;suth\;}0<c\leqslant x,\,\forall x\notin C}.$\par\quad
\Blind{(6)} $\Par{BC}D=\Bra{a:a<rd\leqslant bcd,\,\exists\,d\in D^-,\,b\in B^-,\,\exists\,c\text{\;suth\;}0<c\leqslant x,\,\forall x\notin C}.$\par\quad
\Blind{(6)} $\Par{CD}{^-}=\Bra{r:0\geqslant r\geqslant cd,\,\exists\,d\in D^-,\,\exists\,c\text{\;suth\;}\forall x\notin C,\,0<c\leqslant x}.$\par\quad
\Blind{(6)} $B\Par{CD}=\Bra{a:a<br\leqslant bcd,\,\exists\,b\in B^-,\,d\in D^-,\,\exists\,c\text{\;suth\;}\forall x\notin C,\,0<c\leqslant x}.$ \;Done.\vspace{4pt}\par\quad
$BC+BD=\Bra{x:x<bc,\,\forall b\in B^-,\,\forall c\text{\;suth\;}\forall s\notin C,\,0<c\leqslant s}+\Bra{y:y<bd,\,\exists\,b\in B^-,\,d\in D^-}$\par\quad
$\Blind{BC+BD}=\Bra{a:a<pc+qd,\,\forall p\in B^-,\,\forall c\text{\;suth\;}\forall s\notin C,\,0<c\leqslant s,\text{\;and\;}\exists\,q\in B^-,\,d\in D^-}.$\vspace{2pt}\par\quad
%$\Blind{BC+BD}=\Bra{a:a<b\Par{c+d},\,\forall b\in B^-,\,\forall c\text{\;suth\;}\forall s\notin C,\,0<c\leqslant s,\text{\;and\;}\exists\,d\in D^-}.$\par\quad
(I) If $C=-D.$ \,Then $B\Par{C+D}=\tilde{0}.$ \;Becs $\Qbb\Backslash C=\Qbb\Backslash{{-D}}=\Bra{s:s\geqslant -r,\:\forall r\notin D}.$\par\quad\HI
Thus ``$\forall s\notin C,\,0<c\leqslant s$'' is equiv to ``$\forall r\notin D,\,0<c\leqslant -r$''.\par\quad\HI
Done.\vspace{2pt}\par\quad
(II) If $C+D$ not posi. Then $B\Par{C+D}=\Bra{a:a<bx,\,\exists\,b\in B^-,\,x>c+d,\,\forall c+d\in C+D}.$\par\quad\HII
