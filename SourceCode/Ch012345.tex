...
\Blind{$CD$}${}=\Bra{{a}:a<-cd,\,\forall d\in D^+,\,\forall c\text{\;suth\;}$\uline{$0<c<-r,\,\exists\,r$}${}\in C^-}$\hfill{\FontSmall\BigPar{$rd<{}$\uline{$-cd<0$}}}\TextB{}
$\Blind{CD}=\Bra{a:a<td,\,\forall d\in D^+,\,\forall t\text{\;suth\;}r<t<0,\,\exists\,r\in C^-}$\TextB{}
$\Blind{CD}=\Bra{a:a<rd,\,\forall d\in D^+,\,\forall r\in C^-\nonzero}.$
\SepLine
