...
}Let $\Rbb\Backslash F=\bigcup_{k=1}^\infty I_k$ \Par{disj} 
\SepLine
...
WLOG, asum $F_{\!1},F_{\!2}$ not open, and $x\in F_{\!1},y\in F_{\!2}$ with $x<y\Rightarrow x,y\in U\supseteq\Interval{[}{]}{x,y}.$\parSol{}
