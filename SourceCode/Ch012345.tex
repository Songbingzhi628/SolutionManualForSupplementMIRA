...
$\forall s\notin D,\forall d\in D^+,\,d<s\Rightarrow\forall c\in C,\forall r\in C^-,\,rd>cd>cs,$ \OR $rd>rs>cs.$ \:Thus $RHS\subseteq LHS.$\TextB{}
Rewrite $a\big/d<r,\,\forall r\in C^-,\,d\in D^+\Longleftrightarrow a\big/d\in C,\,\forall d\in D^+.$ Asum $\exists\,a\in LHS$ suth $a\big/s\neq c,\,\forall c,s.$\TextB{}
Note that $\forall s\notin D,d\in D^+,\:0<a\;\!\Par{1\big/s-1\big/d}\Rightarrow\forall\varepsilon>0,\,\exists\,s,d$ suth $\varepsilon=a\;\!\Par{1\big/s-1\big/d}.$\TextB{}
