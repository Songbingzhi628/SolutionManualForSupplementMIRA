...
%	\TextA{Prove $\,f$ Rieman integ $\Longleftrightarrow\forall\varepsilon>0,\exists\,P$ suth $U\Par{\,f,P}-L\Par{\,f,P}\leqslant\varepsilon.$}
%}Supp $\,f$ Rieman integ. Asum $\exists\,\varepsilon,\forall P,\,U\Par{\,f,P}-L\Par{\,f,P}>\varepsilon.$ Ctradic.\parSol{}
%Convly, becs $U\Par{\,f}-L\Par{\,f}\leqslant U\Par{\,f,P}-L\Par{\,f,P}\leqslant\varepsilon.$\PfEnd
%\SepLine

\Anchor{1T1}\BulletPointX\TipsN{1}\,\,\,Supp $I=\Interval{[}{]}{a,b}$ and $\,f,g:I\rightarrow\Rbb$ is bounded and $P$ is a parti. Then\vspace{1pt}\TextB{}
(a) $\Inf_{I}\;f+\Inf_{I}\,g\leqslant\Inf_{I}\Par{\,f+g}\leqslant\Sup_{I}\Par{\,f+g}\leqslant\Sup_{I}\;f+\Sup_{I}\,g$\TextB{}
\Ha(1) $L\Par{\,f,P}+L\Par{g,P}\leqslant L\Par{\,f+g,P}\leqslant L\Par{\,f+g}\Longrightarrow L\Par{\,f}+L\Par{g}\leqslant L\Par{\,f+g}.$\TextB{}
\Ha(2) $U\Par{\,f+g}\leqslant U\Par{\,f+g,P}\leqslant U\Par{\,f,P}+U\Par{g,P}\Longrightarrow U\Par{\,f+g}\leqslant U\Par{\,f}+U\Par{g}.$
%\TextB{}
...
\Hb$\Longrightarrow U\Par{\,f}=\inf U_f=-\sup L_{-f}=-L\Par{{-\,f}}.$\vspace{3pt}\TextB{}
%\Hb\ACoro\Onumber{A.5}\quad$f$ Rieman integ $\Rightarrow -L\Par{{-\,f}}=U\Par{\,f}=L\Par{\,f}=-U\Par{{-\,f}}\Rightarrow{-\,f}$ Rieman integ.
(c) Let $P,P'$ be parti. Let $P''=P\cup P'.$ Then $U\Par{\,f,P}-L\Par{\,f,P'}\geqslant U\Par{\,f,P''}-L\Par{\,f,P''}.$\TextB{}
\Hc Thus $\Inf\Bra{U\Par{\,f,P}-L\Par{\,f,P'}:P,P'}=\Inf\Bra{U\Par{\,f,P}-L\Par{\,f,P}:P}.$\TextB{}
\Hc\AComm $LHS=\Inf\Bra{U\Par{\,f,P}-L\Par{\,f,P'}:P,P'}=U\Par{\,f}-L\Par{\,f}.$
\SepLine

\ProblemN{A.3}{
	\TextA{Supp bounded $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$}
	\TextA{Prove [P] $\,f$ Rieman integ $\Longleftrightarrow\forall k\in\Nbp,\exists$ parti $P_{\!k}$ suth $U\Par{\,f,P_{\!k}}-L\Par{\,f,P_{\!k}}<1\big/k.$ [Q]}
}$Q\Rightarrow P:$ \:$0=\Inf\Bra{U\Par{\,f,P}-L\Par{\,f,P'}:P,P'}=\Inf_P\:\!U\Par{\,f,P}+\Inf_P\:\!{-}L\Par{\,f,P}=U\Par{\,f}-L\Par{\,f}.$\parSol{}
${^\neg}Q\Rightarrow{^\neg}P:$ \:$\exists\,k\in\Nbp,\forall P,\:\Inf\Bra{U\Par{\,f,P}-L\Par{\,f,P}:P}\geqslant 1\big/k.$ \,By \TIPSN{1}(c).\PfEnd
\SepLine

\ProblemN{A.6}{
	\TextA{Supp Rieman integ $\,f:\Interval{[}{]}{a,b}\rightarrow\Rbb.$ \,Supp $g:\Interval{[}{]}{a,b}\rightarrow\Rbb$ suth $g\Par{x}=\;\!f\Par{x}$}
	\TextA{\,for all $x\in\Interval{[}{]}{a,b}\Backslash\Bra{r_{\:\!\!1},\dots,r_{\:\!\!n}}.$ \,Prove $g$ is Rieman integ and $\int_a^bg=\int_a^b\:\!f.$}
}
\SepLine
