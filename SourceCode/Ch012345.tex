...
}Asum $\forall a\in A,\exists\,b\in A,\;f\Par{b}>\;\!f\Par{a}.$ Let $.$
\SepLine
...
\ProblemN{22}{
	\TextA{Supp $\Rbbn\supseteq F_1\supseteq F_2\supseteq\cdots$ is a decre seq of non-$\emptySet$ subsets. Prove $\bigcap{_{k=1}^\infty}F_k\neq\emptySet.$}
}
\SepLine
