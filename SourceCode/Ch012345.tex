...
\Anchor{0DN065}\ProblemB{
	\TextA{Supp nonempty $A$ is closed and open subsets of $\RbbP{n}.$ Prove $A=\RbbP{n}.$}
}Asum $A\neq\RbbP{n}.$ \,Let\;$a\in A,\,b\in\RbbP{n}\Backslash A.$ \,Define \,$f\Par{t}=\Par{1-t}\:\!a+t\:\!b.$\par\quad
...
(II) If $c\in\RbbP{n}\Backslash A.$ \,Simlr. \,$\forall t'\in\Interval{[}{)}{t_M-\varepsilon,\:t_M},\,t'\notin\mA.$ \,Now $\forall t\in\mA,\,t<t_M\Rightarrow t<t_M-\varepsilon.$\PfEnd
\SepLine\pagebreak
...
\Anchor{0D20}\ProblemN{20}{
	\TextA{Prove $\forall b\in\RbbP{n},\,\delta>0,\,B=\Bra{a\in\RbbP{n}:\Dvert{a-b}\leqslant\delta}$ are open.}
...
$\Dvert{a_k-L}<\varepsilon\Rightarrow\delta<\Dvert{L-b}\leqslant\Dvert{a_k-L}+\Dvert{a_k-b}<\delta+\varepsilon.$ \,Let $\varepsilon=\Dvert{L-b}.$ \,Ctradic.\PfEnd
\SepLine
...
\ProblemN{1}{
	\TextA{Prove every convg seq in $\RbbP{n}$ is bounded.}
}Supp $a_1,a_2,\dots\in\RbbP{n}$ suth $\forall\varepsilon>0,\exists\,m\in\Nbp,\forall k\geqslant m,\:\aXMid{\Dvert{a_k}{_\infty}-\Dvert{L}{_\infty}}\leqslant\Dvert{a_k-L}{_\infty}<\varepsilon.$\parSol{}
Thus $\Dvert{a_k}{_\infty}\in\XInterval{(}{)}{\aXMid{\varepsilon-\Dvert{L}{_\infty}},\,\varepsilon+\Dvert{L}{_\infty}}.$ \,Now asum $\Sup\Bra{\Dvert{a_k}{_\infty}:k\in\Nbp}=\infty.$\vspace{2pt}\parSol{}
Which means $\forall T\in\Rbp,\forall m\in\Nbp,\exists\,k>m,\,\max\!\Bra{\Dvert{a_1}{_\infty},\dots,\Dvert{a_m}{_\infty}}<\Dvert{a_k}{_\infty}>T.$ \,Ctradic.\PfEnd
\SepLine

\ProblemN{3}{
	\TextA{Supp $F\subseteq\RbbP{n}$ suth every seq in $F$ has a subseq that convg in $F.$ Prove $F$ is closed bounded.}
}Supp $a_1,a_2,\cdots\in F$ and $\exists\,k_1,k_2,\cdots$ incre in $\Nbp$ suth 
$a_{k_1},a_{k_2},\cdots$ convg to $L\in F.$\parSol{}
Asum $\Sup F=\infty\Rightarrow\forall a\in F,\exists\,b\in F,\,b>a.$
\SepLine
