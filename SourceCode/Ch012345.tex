...
\BulletPointX $LHS=\Bra{a:a<ru,\:\forall r\in C^-,\,0<u\leqslant s,\,\forall s\notin D},\;\Bra{a:a<rd,\:\forall r\in C^-,\,\forall d\in D^+}=RHS.$\TextB{}
...
(II) Othws, \,$s_M=\min \Qbb\Backslash D.$ \,Now in $LHS$, ``$a<rs_M,\,\forall r\in C^-$''.\TextB{}
...
%\Or Consider $-C$ not posi and $-D$ posi. Omitting $D=\tilde{0}.$\TextB{}
%$CD=\Par{{-C}}\Par{{-D}}=\Bra{a:a<u\:\!w,\,\forall u\in\Par{{-C}}{^-},\,\forall w\in\Par{{-D}}{^+}}=\Bra{a:a<cs,\,\forall s\in D^-\nonzero,\,\forall c\in C^+}$
\SepLine
...
Now $\forall r\in C^-,\forall d\in D^+,\;r\:\!d>r_{\:\!\!1}\:\!d'+\varepsilon\:\!d'.$ 又 $r_{\:\!\!1}\:\!d'>r\:\!d'>r\:\!d$ \,and\, $\varepsilon\:\!d'>0.$ Ctradic.\PfEnd
\SepLine
