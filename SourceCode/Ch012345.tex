...
}Asum $a_1,a_2,\cdots\in F$ convg with lim $L\notin F.$ 又 $\exists$ convg subseq with lim $L'\in F$ but not in seq.\parSol{}
$\forall\varepsilon>0,\exists\,k_m\in\Nbp,\forall k_j\in\;\!\!\Bra{k_m,k_{m+1},\cdots},\:\Dvert{L-L'}\leqslant\Dvert{a_{k_m}-L}+\Dvert{a_{k_m}-L'}<2\:\!\varepsilon.$ Ctradic.\parSol{}
