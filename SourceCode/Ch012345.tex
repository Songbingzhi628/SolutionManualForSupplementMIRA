...
}Asum $\Delta>0$ and $\exists\,a_1,a_2,\cdots\in F$ suth each $\Dvert{a_{k+1}-a_k}\geqslant\Dvert{a_{k+1}}-\Dvert{a_k}\geqslant\Delta.$\parSol{}
Then $\exists$ subseq $\,f\Par{a_{k_1}\:\!\!},\,f\Par{a_{k_2}\:\!\!},\cdots$ convg to some $L.$ Define $\,f\Par{a}=\Dvert{a}{_\infty}.$ Ctradic.\vspace{3pt}\parSol{}
$\forall$\:\!convg $a_1,a_2,\cdots\in F,\,\forall\varepsilon>0,\exists\,\delta>0,\exists\,m,\forall j,k\geqslant m,\:a_j\in B\Par{a_k,\delta},\;f\Par{a_j}\in B\BigPar{\,f\Par{a_k},\varepsilon}.$\parSol{}
By Exe\;\!(33), $\,f\Par{a_1},\,f\Par{a_2},\cdots$ convg to some $L$ for all continu $\,f.$\parSol{}
(How to?)Construct an $\,f$ suth $L=\supf\Par{F}\Rightarrow\exists\,a_M\in F$ suth $a_M=\lim_{k\rightarrow\infty}a_k.$\PfEnd
\SepLine
